...
export const mockPostsArtigos: MediaPost[] = [
  {
    id: 101,
    type: 'artigo',
  ...
  },
  {
    ...
    stats: {
      ...
      time: '1 dia atrás',
      content:
        'Os riscos e benefícios do uso de IA em contextos sensíveis como saúde, segurança e educação.',
      comments: 332,
      likes: 3201,
      dislikes: 45,
    },
  },
  {
    ...
    stats: {
      ...
      time: '3 dias atrás',
      content:
        'Conheça os principais fatores que contribuem para a mudança do clima e como combatê-los.',
      comments: 274,
      likes: 4102,
      dislikes: 22,
    },
